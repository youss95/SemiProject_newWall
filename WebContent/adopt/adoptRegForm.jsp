								...
								<div class="terms">
									<div class="box">
										<ol>
											...
											<li>개인정보의 수집,이용 목적: 본 서명의 목적에 맞는 카라의 캠페인에 활용하고, 추후 전개되는 바에 대한 소식을 전달하기 위함</li>
						...
						<dl>
							...
							<dd>
								<div class="terms">
									<div class="box">
										<ol>
											<li>본인(이하 '입양인'이라 합니다.)은 동물권행둥 카라 (이하 '단체'라 합니다.)를 통하여 반려동물(이하 '입양동물'이라
											...
											<li>수집하는 개인정보의 항목: 성명, 주소, 이메일, 휴대전화번호</li>
											<li>개인정보의 수집,이용 목적: 본 서명의 목적에 맞는 카라의 캠페인에 활용하고, 추후 전개되는 바에 대한 소식을 전달하기
												위함</li>
											<li>개인정보의 보유 및 이용기간: 5년(관계법령에서 정한 일정한 기간)</li>
										</ol>
									</div>
