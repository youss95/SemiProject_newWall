						...
						<div>
							<table>
								<tr>
									...
									<td><input type="text" name="id" id="id" class="inpform"
										maxlength=16 required /> <input type="button" id="check"
										value="중복확인" class="btn_s btn_light"></td>
								</tr>
								<tr>
									<td><label for="pwd">비밀번호 </td>
									<td><input type="password" name="pwd" id="pwd"
										class="inpform" maxlength=16 required /> <!-- *영문 대소문자/숫자/특수문자를 혼용하여 2종류10~16자 또는 3종 8~16자 --></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input type="text" name="email" id="email" size="10"
										class="inpform" required />@ <select id="email2"
										class="inpform">
											<option value=""></option>
									...
									</select> <input type="button" id="check2" value="중복확인"
								...
								<tr>
									...
									<td><span class="box"> <input type="text" id="yy"
											...
											class="inpform" maxlength="1" placeholder="일">
									</span></td>
								</tr>
								<tr>
									...
									</select> - <input type="text" name="phone" id="phone" size="10"
										class="inpform">- <input type="text" name="phone"
										id="phone" size="10" class="inpform"></td>
								</tr>
								<tr>
								<tr>
									<td>성별</td>
								...
								<tr>
									...
									<td><input type="text" name="dong" id="dong" size="5"
										class="inpform">- <input type="text" name="dong"
										id="dong" size="5" class="inpform"> <input
								...
								<td><select id="phone" name="phone id=">
										...
										<option value="011">011</option>
										<option value="019">019</option>
								</select> -<input type="text" name="Phone1" size="5" class="inpform">
									-<input type="text" name="Phone2" size="5" class="inpform"></td>
								</tr>
								<tr>
								</tr>
							</table>
