									...
									<div>
										<table>
											...
											<tr>
												...
												<td><input type="password" name="pwdCheck" id="pwdCheck" class="inpform"
														maxlength=16 required></td>
											</tr>
											<tr>
												<td><label for="email">이메일</label></td>
												<td><input type="text" name="email" id="email" class="inpform"
														maxlength=16> @ <select id="emailSuffix" class="inpform">
											...
											<tr>
												...
												<td><input type="text" name="name" id="name" class="inpform"
														maxlength=20 required></td>
											</tr>

											<tr>
												<td>생년월일</td>
												<td><span class="box"> <select id="birthday_yy" class="int inpform"
															name="birthday_yy" required>
															<option disabled selected>년</option>
														</select>
													</span> <span class="box"> <select id="birthday_mm" class="inpform"
															name="birthday_mm" required>
											...
											<tr>
												...
												<td><select class="inpform" name="contact1" id="contact1">
														...
														id="contact2" maxlength=4> - <input type="text" name="contact3"
														id="contact3" class="inpform" maxlength=4></td>
											</tr>
											<tr>
												<!-- 	<tr>
									<td>입양 신청 상태</td>
									<td><input type="radio" name="status" value="Y">Yes
										...
										checked>No</td>
											...
											<tr>
												...
												<td><input type="text" name="postcode" id="postcode" class="inpform"
														maxlength=5> <input type="button" id="searchAddr" value="우편번호검색"
														class="btn_s btn_light" required></td>
											</tr>
											<tr>
												<td><label for="address1">주소</label></td>
												<td><input type="text" name="address1" id="address1" class="inpform"
														placeholder="도로명/지번" maxlength=100 required></td>
											</tr>
											<tr>
												<td><label for="address2">상세주소</label></td>
												<td><input type="text" name="address2" id="address2" class="inpform"
														maxlength=100 required></td>
											</tr>
										</table>
										<input type="submit" id="join" value="회원가입" class="btn_m btn_default">
									</div>
								</form>
							</section>
						</div>
