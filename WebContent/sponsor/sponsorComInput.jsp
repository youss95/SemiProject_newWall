...
<script src="${pageContext.request.contextPath}/resources/js/common.js"></script>
    <style>
        ...
        * {
		...
		.sp_com_input .spp_category2 .ph:first-of-type{margin-left:0;}
        ...
        .sp_com_input .spp_category2 .phone h3 span,
        .sp_com_input .spp_category2 .name h3 span,
                        ...
                        <div class="spp_body">
                            ...
                            <form action="${pageContext.request.contextPath}/PaymentCheck.sp" method="post"
                                ...
                                <div class="spp_category3 spp_category">
                                    <h2 class="spp_category1_title">후원 분야 선택</h2>
                                    <!-- 수평선 -->
                                ...
                                <div class="spp_category4 spp_category">
									...
									<div class="terms">
										...
										<div class="box">
											<ul>
												<li>개인정보 제3자 제공•이용에 대한 동의를 거부할 권리가 있습니다. 동의를 거부할 경우 기부금 결제 등에 제한을 받을 수 있습니다.</li>
										 ...
										 <div class="rd_group">
                                            ...
                                            <div class="inp_rd">
                                                ...
                                                <label for="sp_terms02_2">동의하지 않습니다</label>
                                            </div>
                                        </div>
									</div>
                                </div>
