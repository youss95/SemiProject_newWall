								...
								<div class="spp_category2 spp_category">
									...
									<div class="a14up" id="a14up">
										...
										<div class="birth">
											...
											<!-- 사이즈 만지기?? 이거 안됨  -->
											<div class="">
												<input type="number" class="inpform bi_y sp_bi01"
													id="sp_bi_y_01" name="sp_bi_y_01" placeholder="1999"
													required>
											</div>
											년
											...
											일 <span class="sp_bi_01_reg sp_reg" id="sp_bi_01_reg">올바른
												생년월일 작성해주세요</span>
										</div>
										...
										<div class="birth">
											...
											<div class="">
												<input type="number" class="inpform bi_y" id="sp_bi_y_02"
													name="sp_bi_y_02" placeholder="1999">
											</div>
											년
											<div class="inp_slct bi">
											...
											일 <span class="sp_bi_02_reg sp_reg" id="sp_bi_02_reg">올바른
												생년월일 작성해주세요</span>
										</div>
										<div class="name">
											<h3>
										...
										<div class="birth">
											...
											<div class="">
												<input type="number" class="inpform bi_y" id="sp_ybi_y"
													name="sp_ybi_y" placeholder="2008">
											</div>
											년
											<div class="inp_slct bi">
											...
											일 <span class="sp_ybi_reg sp_reg" id="sp_ybi_reg">올바른
												생년월일 작성해주세요</span>
										</div>
									</div>
								</div>
