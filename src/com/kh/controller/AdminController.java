...
//               String lostFileRealName = multi.getFilesystemName(str); //실제에 서버에 업로드가된 네임
				...
				AnimalDTO adto = new AnimalDTO(null, anName, anCategory, anGender, anKind, anAge, anWeight, anCharacter, anDate, anStatus, anContnets, null);
				...
				for(String fileName : fileNames) {
					...
					fdao.fileUpload(new AnimalFilesDTO(0, oriName, sysName, null, adto.getCode_seq()));
				}
				...
				String sysName = multi.getFilesystemName("file1");

				FileDTO fdto = new FileDTO(0, oriName, sysName, null, seq);

				if(oriName != null) {
					int result = fdao.fileUpload(fdto);
				}
				 */
