...
public class SponsorDTO {
	...
	private String sponsor_division;
	...
	public SponsorDTO(int sponsor_seq, int sponsor_amount, String sponsor_division, String sponsor_agecheck,
		...
		this.sponsor_division = sponsor_division;
	...
	public SponsorDTO(int sponsor_amount, String sponsor_agecheck, String sponsor_name, String sponsor_contact,
			String sponsor_birth, String sponsor_yname, String sponsor_ybirth, String sponsor_email,
			String sponsor_terms01, String sponsor_terms02, String sponsor_mb_id) {
		super();
		this.sponsor_amount = sponsor_amount;
		this.sponsor_agecheck = sponsor_agecheck;
		this.sponsor_name = sponsor_name;
	...
	public String getSponsor_division() {
		return sponsor_division;
	}
	public void setSponsor_division(String sponsor_division) {
		this.sponsor_division = sponsor_division;
	}
